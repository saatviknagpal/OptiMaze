...
function App() {
  ...
  const handleSubmit = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setY(0);
        setMoveDistance(
          (changeMoveDistance(width) * 0.8) / res.data.maze.length
        );
        setPlayerPos([0, 0]);
  ...
  const shareToTelegram = () => {
    ...
    const subMessage =
      userPathLength === shortestPathLength
    ...
    const message =
      subMessage + "Try it out at https://a-mazing-journey.azurewebsites.net/";
            ...
            <div className="input-container">
              ...
              {maze ? (
                !mazeStarted ? (
                  ...
                  <div>
                    {!showStats ? <h1>OptiMaze</h1> : <h1>Your stats</h1>}
                    {!showStats ? (
